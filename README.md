...
| `ETL_SECRET` | Segredo HMAC compartilhado com o robô PowerShell (ver `Security.gs`). Gerar com `gerarSegredoETL()` e definir com `definirSegredoETL()`, rodando manualmente no editor — nunca hardcode no código. |
